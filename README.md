**:warning: This project is a fork of oznu/docker-guacamole, which is archived and no longer supported. My test envirionments do not include LDAP or other authentication services at this time.**
